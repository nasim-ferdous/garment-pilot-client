...
const Dashboard = () => {
  const { role } = useRole();
  return (
    <div className="drawer lg:drawer-open bg-indigo-300 dark:bg-zinc-700">
      <title>Dashboard</title>
      <input id="my-drawer-4" type="checkbox" className="drawer-toggle" />
      <div className="drawer-content">
        {/* Navbar */}
        <nav className="navbar w-full bg-indigo-200 dark:bg-zinc-500">
          <label
            htmlFor="my-drawer-4"
      ...
      <div className="drawer-side is-drawer-close:overflow-visible">
        ...
        ></label>
        <div className="flex min-h-full flex-col items-start bg-indigo-200 dark:bg-zinc-500 is-drawer-close:w-14 is-drawer-open:w-64">
