...
import UpdateProductModal from "../ManageProducts/UpdateProductModal";
...
const AdminAllProducts = () => {
  ...
  const {
    ...
    queryKey: ["admin-all-products", searchText],
    queryFn: async () => {
      const res = await axiosSecure.get(
        `/all-products?searchText=${searchText}`
      );
      return res.data;
    },
  });
  ...
  const handleToggleHome = async (product) => {
    try {
      await axiosSecure.patch(`/products/show-on-home/${product._id}`, {
        showOnHomePage: !product.showOnHomePage,
      });

      Swal.fire({
        icon: "success",
        title: product.showOnHomePage ? "Removed from Home" : "Shown on Home",
        timer: 1200,
                  ...
                  <tr key={product._id}>
                    ...
                    <td className="text-center">
                      <input
                        ...
                        checked={product.showOnHomePage === true}
